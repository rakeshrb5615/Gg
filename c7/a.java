package c7;
public final class a extends w6.z {
    ...
    private a()
    {
        this.a = new java.text.SimpleDateFormat("MMM d, yyyy");
        return;
    }
    ...
    {
        if (((java.sql.Date) p3) != null) {
            p2.I(this.a.format(((java.sql.Date) p3)));
            return;
        } else {
            p2.B();
            return;
