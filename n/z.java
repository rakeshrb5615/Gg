package n;
public class z extends android.widget.ImageView {
    public final n.p a;
    public final g0.d b;
    public boolean c;

    public z(android.content.Context p1, android.util.AttributeSet p2, int p3)
    {
        n.u2.a(p1);
        super(p1, p2, p3);
        super.c = 0;
    ...
    public void setImageResource(int p4)
    {
        ...
        if (v0 != null) {
            ...
            if (p4 == 0) {
                ...
                int v4_1 = j5.t1.A(v1_1.getContext(), p4);
                if (v4_1 != 0) {
                    n.n1.a(v4_1);
                }
                v1_1.setImageDrawable(v4_1);
            }
            v0.a();
        }
        return;
