package n;
public class o extends android.widget.AutoCompleteTextView {
    ...
    static o()
    {
        n.o.d = new int[] {16843126});
        return;
    }

    public o(android.content.Context p5, android.util.AttributeSet p6)
    {
        n.u2.a(p5);
        super(p5, p6, 2130968648);
        n.t2.a(super, super.getContext());
        android.text.method.KeyListener v5_1 = b8.g.p(super.getContext(), p6, n.o.d, 2130968648);
