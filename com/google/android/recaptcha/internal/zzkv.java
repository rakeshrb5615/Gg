...
final class zzkv extends com.google.android.recaptcha.internal.zzkr implements java.util.RandomAccess, com.google.android.recaptcha.internal.zznk, com.google.android.recaptcha.internal.zzor {
    ...
    static zzkv()
    {
        ...
        com.google.android.recaptcha.internal.zzkv.zza = v1;
        new com.google.android.recaptcha.internal.zzkv(v1, 0, 0);
        return;
    }

    public zzkv()
    {
        this(com.google.android.recaptcha.internal.zzkv.zza, 0, 1);
        return;
    }

    private zzkv(boolean[] p1, int p2, boolean p3)
    {
        super(p3);
        super.zzb = p1;
        super.zzc = p2;
    ...
    public final synthetic void add(int p5, Object p6)
    {
        ...
        if (p5 >= 0) {
            ...
            if (p5 <= v0_4) {
                ...
                if (v0_4 >= v3_0) {
                    boolean[] v0_1 = new boolean[com.google.android.recaptcha.internal.zzkv.zzg(v3_0)];
    ...
    public final boolean addAll(java.util.Collection p6)
    {
        ...
        if ((p6 instanceof com.google.android.recaptcha.internal.zzkv)) {
            int v0_5 = ((com.google.android.recaptcha.internal.zzkv) p6).zzc;
            if (v0_5 != 0) {
                int v2_1 = this.zzc;
                if ((2147483647 - v2_1) < v0_5) {
                    ...
                    System.arraycopy(((com.google.android.recaptcha.internal.zzkv) p6).zzb, 0, this.zzb, this.zzc, ((com.google.android.recaptcha.internal.zzkv) p6).zzc);
                    this.zzc = v2_0;
                    this.modCount = (this.modCount + 1);
                    return 1;
                }
    ...
    public final boolean equals(Object p6)
    {
        if (this != p6) {
            if ((p6 instanceof com.google.android.recaptcha.internal.zzkv)) {
                if (this.zzc == ((com.google.android.recaptcha.internal.zzkv) p6).zzc) {
                    int v1_0 = 0;
                    while (v1_0 < this.zzc) {
                        if (this.zzb[v1_0] == ((com.google.android.recaptcha.internal.zzkv) p6).zzb[v1_0]) {
                            v1_0++;
                        } else {
                            return 0;
                        }
    ...
    public final int hashCode()
    {
        ...
        int v1_0 = 1;
        while (v0 < this.zzc) {
            v1_0 = ((v1_0 * 31) + com.google.android.recaptcha.internal.zznl.zza(this.zzb[v0]));
            v0++;
        }
        return v1_0;
    }
    ...
    public final bridge synthetic com.google.android.recaptcha.internal.zznk zzd(int p4)
    {
        if (p4 < this.zzc) {
            ...
            if (p4 != null) {
                ...
                v4_3 = com.google.android.recaptcha.internal.zzkv.zza;
            }
            return new com.google.android.recaptcha.internal.zzkv(v4_3, this.zzc, 1);
        }
    }
    ...
    public final void zze(boolean p5)
    {
        ...
        if (this.zzc == v1_2) {
            boolean[] v0_3 = new boolean[com.google.android.recaptcha.internal.zzkv.zzg(v1_2)];
