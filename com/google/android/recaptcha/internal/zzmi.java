...
final class zzmi extends com.google.android.recaptcha.internal.zzkr implements java.util.RandomAccess, com.google.android.recaptcha.internal.zznk, com.google.android.recaptcha.internal.zzor {
    ...
    static zzmi()
    {
        ...
        com.google.android.recaptcha.internal.zzmi.zza = v1;
        new com.google.android.recaptcha.internal.zzmi(v1, 0, 0);
        return;
    }

    public zzmi()
    {
        this(com.google.android.recaptcha.internal.zzmi.zza, 0, 1);
        return;
    }

    private zzmi(double[] p1, int p2, boolean p3)
    {
        super(p3);
        super.zzb = p1;
        super.zzc = p2;
    ...
    public final synthetic void add(int p6, Object p7)
    {
        ...
        if (p6 >= 0) {
            ...
            if (p6 <= v7_7) {
                ...
                if (v7_7 >= v4_0) {
                    double[] v7_4 = new double[com.google.android.recaptcha.internal.zzmi.zzh(v4_0)];
    ...
    public final boolean addAll(java.util.Collection p6)
    {
        ...
        if ((p6 instanceof com.google.android.recaptcha.internal.zzmi)) {
            int v0_5 = ((com.google.android.recaptcha.internal.zzmi) p6).zzc;
            if (v0_5 != 0) {
                int v2_1 = this.zzc;
                if ((2147483647 - v2_1) < v0_5) {
                    ...
                    System.arraycopy(((com.google.android.recaptcha.internal.zzmi) p6).zzb, 0, this.zzb, this.zzc, ((com.google.android.recaptcha.internal.zzmi) p6).zzc);
                    this.zzc = v2_0;
                    this.modCount = (this.modCount + 1);
                    return 1;
                }
    ...
    {
        if (this != p9) {
            if ((p9 instanceof com.google.android.recaptcha.internal.zzmi)) {
                if (this.zzc == ((com.google.android.recaptcha.internal.zzmi) p9).zzc) {
                    int v1_0 = 0;
                    while (v1_0 < this.zzc) {
                        if (Double.doubleToLongBits(this.zzb[v1_0]) == Double.doubleToLongBits(((com.google.android.recaptcha.internal.zzmi) p9).zzb[v1_0])) {
                            v1_0++;
                        } else {
                            return 0;
                        }
    ...
    public final bridge synthetic com.google.android.recaptcha.internal.zznk zzd(int p4)
    {
        if (p4 < this.zzc) {
            ...
            if (p4 != null) {
                ...
                v4_3 = com.google.android.recaptcha.internal.zzmi.zza;
            }
            return new com.google.android.recaptcha.internal.zzmi(v4_3, this.zzc, 1);
        }
    }
    ...
    public final void zzf(double p5)
    {
        ...
        if (this.zzc == v1_2) {
            double[] v0_3 = new double[com.google.android.recaptcha.internal.zzmi.zzh(v1_2)];
    ...
    public final void zzg(int p2)
    {
        ...
        if (p2 > v0_1) {
            ...
            while (v0_1 < p2) {
                v0_1 = com.google.android.recaptcha.internal.zzmi.zzh(v0_1);
            }
