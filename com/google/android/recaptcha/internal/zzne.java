...
final class zzne extends com.google.android.recaptcha.internal.zzkr implements java.util.RandomAccess, com.google.android.recaptcha.internal.zzni, com.google.android.recaptcha.internal.zzor {
    private static final int[] zza;
    private static final com.google.android.recaptcha.internal.zzne zzb;
    private int[] zzc;
    private int zzd;
    ...
    {
        int[] v1 = new int[0];
        com.google.android.recaptcha.internal.zzne.zza = v1;
        com.google.android.recaptcha.internal.zzne.zzb = new com.google.android.recaptcha.internal.zzne(v1, 0, 0);
        return;
    }

    public zzne()
    {
        this(com.google.android.recaptcha.internal.zzne.zza, 0, 1);
        return;
    }

    private zzne(int[] p1, int p2, boolean p3)
    {
        super(p3);
        super.zzc = p1;
        super.zzd = p2;
    ...
    public static com.google.android.recaptcha.internal.zzne zzf()
    {
        return com.google.android.recaptcha.internal.zzne.zzb;
    }
    ...
    private final String zzk(int p4)
    {
        return v1.a.i("Index:", p4, this.zzd, ", Size:");
    }

    private final void zzl(int p2)
    {
    ...
    public final synthetic void add(int p5, Object p6)
    {
        ...
        if (p5 >= 0) {
            ...
            if (p5 <= v0_4) {
                ...
                if (v0_4 >= v3_0) {
                    int[] v0_1 = new int[com.google.android.recaptcha.internal.zzne.zzj(v3_0)];
        ...
        throw new IndexOutOfBoundsException(this.zzk(p5));
    }
    ...
    public final boolean addAll(java.util.Collection p6)
    {
        ...
        if ((p6 instanceof com.google.android.recaptcha.internal.zzne)) {
            int v0_5 = ((com.google.android.recaptcha.internal.zzne) p6).zzd;
            if (v0_5 != 0) {
                int v2_1 = this.zzd;
                if ((2147483647 - v2_1) < v0_5) {
                    ...
                    System.arraycopy(((com.google.android.recaptcha.internal.zzne) p6).zzc, 0, this.zzc, this.zzd, ((com.google.android.recaptcha.internal.zzne) p6).zzd);
                    this.zzd = v2_0;
                    this.modCount = (this.modCount + 1);
                    return 1;
                }
    ...
    public final boolean equals(Object p6)
    {
        if (this != p6) {
            if ((p6 instanceof com.google.android.recaptcha.internal.zzne)) {
                if (this.zzd == ((com.google.android.recaptcha.internal.zzne) p6).zzd) {
                    int v1_0 = 0;
                    while (v1_0 < this.zzd) {
                        if (this.zzc[v1_0] == ((com.google.android.recaptcha.internal.zzne) p6).zzc[v1_0]) {
                            v1_0++;
                        } else {
                            return 0;
                        }
    ...
    public final bridge synthetic com.google.android.recaptcha.internal.zznk zzd(int p1)
    {
        return this.zzg(p1);
    }
    ...
    public final com.google.android.recaptcha.internal.zzni zzg(int p4)
    {
        if (p4 < this.zzd) {
            ...
            if (p4 != null) {
                ...
                v4_3 = com.google.android.recaptcha.internal.zzne.zza;
            }
            return new com.google.android.recaptcha.internal.zzne(v4_3, this.zzd, 1);
        }
    }
    ...
    public final void zzh(int p5)
    {
        ...
        if (this.zzd == v1_2) {
            int[] v0_3 = new int[com.google.android.recaptcha.internal.zzne.zzj(v1_2)];
    ...
    public final void zzi(int p2)
    {
        ...
        if (p2 > v0_1) {
            ...
            while (v0_1 < p2) {
                v0_1 = com.google.android.recaptcha.internal.zzne.zzj(v0_1);
            }
