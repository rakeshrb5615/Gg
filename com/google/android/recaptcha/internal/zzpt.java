...
final class zzpt {
    ...
    {
        if ((com.google.android.recaptcha.internal.zzpt.zze(p3)) || (((((p3 + 112) + (p2 << 28)) >> 30) != 0) || ((com.google.android.recaptcha.internal.zzpt.zze(p4)) || (com.google.android.recaptcha.internal.zzpt.zze(p5))))) {
    ...
    {
        if (!com.google.android.recaptcha.internal.zzpt.zze(p3)) {
            if (p2 == -32) {
                if (p3 < -96) {
                    throw new com.google.android.recaptcha.internal.zznn("Protocol message had invalid UTF-8.");
                } else {
            ...
            if (!com.google.android.recaptcha.internal.zzpt.zze(p4)) {
    ...
    {
        if ((p1 < -62) || (com.google.android.recaptcha.internal.zzpt.zze(p2))) {
            throw new com.google.android.recaptcha.internal.zznn("Protocol message had invalid UTF-8.");
        } else {
