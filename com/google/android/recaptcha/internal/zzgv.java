...
public final class zzgv implements com.google.android.recaptcha.internal.zzgx {
    public static final com.google.android.recaptcha.internal.zzgv zza;

    static zzgv()
    {
        com.google.android.recaptcha.internal.zzgv.zza = new com.google.android.recaptcha.internal.zzgv();
        return;
    }
                ...
                if (v10_3 == null) {
                    ...
                    if (!(v0_2 instanceof Integer)) {
                        if (!(v0_2 instanceof int[])) {
                            ...
                            java.util.ArrayList v3_2 = new java.util.ArrayList(v4_3);
                            int v5_3 = 0;
                            while (v5_3 < v4_3) {
                                v3_2.add(Integer.valueOf((v0_3[v5_3] / v10_4)));
                                v5_3++;
                            }
