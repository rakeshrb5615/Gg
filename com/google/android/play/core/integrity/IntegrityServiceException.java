...
public class IntegrityServiceException extends com.google.android.gms.common.api.ApiException {
    ...
    public IntegrityServiceException(int p5, Throwable p6)
    {
        String v1_2 = com.google.android.play.core.integrity.model.a.a(p5);
        StringBuilder v2_1 = new StringBuilder("Integrity API error (");
        v2_1.append(p5);
        v2_1.append("): ");
        v2_1.append(v1_2);
        v2_1.append(".");
