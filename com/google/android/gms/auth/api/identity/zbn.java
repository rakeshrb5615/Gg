...
public final class zbn implements android.os.Parcelable$Creator {
    ...
    public final bridge synthetic Object createFromParcel(android.os.Parcel p8)
    {
        ...
        while (p8.dataPosition() < v0) {
            ...
            if (v5 == 1) {
                v3 = com.google.android.gms.common.internal.safeparcel.SafeParcelReader.readBoolean(p8, v4_0);
            } else {
                if (v5 == 2) {
        ...
        return new com.google.android.gms.auth.api.identity.BeginSignInRequest$PasskeysRequestOptions(v3, v1, v2_0);
    }

    public final synthetic Object[] newArray(int p1)
    {
        com.google.android.gms.auth.api.identity.BeginSignInRequest$PasskeysRequestOptions[] v1_1 = new com.google.android.gms.auth.api.identity.BeginSignInRequest$PasskeysRequestOptions[p1];
        return v1_1;
    }
}
