...
public final class zbr implements android.os.Parcelable$Creator {
    ...
    public final bridge synthetic Object createFromParcel(android.os.Parcel p8)
    {
        ...
        int v1 = 0;
        com.google.android.gms.auth.api.identity.SignInPassword v2_2 = 0;
        String v3 = 0;
        while (p8.dataPosition() < v0) {
            ...
            if (v5 == 1) {
                v2_2 = ((com.google.android.gms.auth.api.identity.SignInPassword) com.google.android.gms.common.internal.safeparcel.SafeParcelReader.createParcelable(p8, v4_0, com.google.android.gms.auth.api.identity.SignInPassword.CREATOR));
            } else {
                if (v5 == 2) {
        ...
        return new com.google.android.gms.auth.api.identity.SavePasswordRequest(v2_2, v3, v1);
    }

    public final synthetic Object[] newArray(int p1)
    {
        com.google.android.gms.auth.api.identity.SavePasswordRequest[] v1_1 = new com.google.android.gms.auth.api.identity.SavePasswordRequest[p1];
        return v1_1;
    }
}
