...
public final class zaa implements android.os.Parcelable$Creator {
    ...
    public final bridge synthetic Object createFromParcel(android.os.Parcel p8)
    {
        ...
        while (p8.dataPosition() < v0) {
            ...
            if (v5 == 1) {
                ...
                if (v5 == 2) {
                    ...
                    if (v5 == 3) {
                        v1 = com.google.android.gms.common.internal.safeparcel.SafeParcelReader.createBundle(p8, v4_0);
                    } else {
        ...
        return new com.google.android.gms.auth.api.signin.internal.GoogleSignInOptionsExtensionParcelable(v2, v3, v1);
    }

    public final synthetic Object[] newArray(int p1)
    {
        com.google.android.gms.auth.api.signin.internal.GoogleSignInOptionsExtensionParcelable[] v1_1 = new com.google.android.gms.auth.api.signin.internal.GoogleSignInOptionsExtensionParcelable[p1];
        return v1_1;
    }
}
