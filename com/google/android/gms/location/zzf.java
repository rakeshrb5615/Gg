...
public final class zzf implements android.os.Parcelable$Creator {
    ...
    public final bridge synthetic Object createFromParcel(android.os.Parcel p9)
    {
        ...
        while (p9.dataPosition() < v0) {
            ...
            if (v6 == 1) {
                ...
                if (v6 == 2) {
                    ...
                    if (v6 == 3) {
                        v1 = com.google.android.gms.common.internal.safeparcel.SafeParcelReader.readLong(p9, v5_0);
                    } else {
        ...
        return new com.google.android.gms.location.ActivityTransitionEvent(v3, v4, v1);
    }

    public final synthetic Object[] newArray(int p1)
    {
        com.google.android.gms.location.ActivityTransitionEvent[] v1_1 = new com.google.android.gms.location.ActivityTransitionEvent[p1];
        return v1_1;
    }
}
