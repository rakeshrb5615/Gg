...
public final class zzad extends com.google.android.gms.common.internal.safeparcel.AbstractSafeParcelable {
    ...
    static zzad()
    {
        com.google.android.gms.fido.fido2.api.common.zzad.CREATOR = new com.google.android.gms.fido.fido2.api.common.zzae();
        return;
    }

    public zzad(boolean p1)
    {
    ...
    {
        if ((p3 instanceof com.google.android.gms.fido.fido2.api.common.zzad)) {
            if (this.zza != ((com.google.android.gms.fido.fido2.api.common.zzad) p3).zza) {
                return 0;
            } else {
                return 1;
            }
