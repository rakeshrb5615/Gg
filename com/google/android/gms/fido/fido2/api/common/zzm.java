    ...
    public final bridge synthetic Object createFromParcel(android.os.Parcel p9)
    {
        ...
        while (p9.dataPosition() < v0) {
            ...
            if (v6 == 2) {
                ...
                if (v6 == 3) {
                    v2 = com.google.android.gms.common.internal.safeparcel.SafeParcelReader.readBooleanObject(p9, v5_0);
                } else {
                    if (v6 == 4) {
        ...
        return new com.google.android.gms.fido.fido2.api.common.AuthenticatorSelectionCriteria(v1, v2, v3, v4);
    }

    public final synthetic Object[] newArray(int p1)
    {
        com.google.android.gms.fido.fido2.api.common.AuthenticatorSelectionCriteria[] v1_1 = new com.google.android.gms.fido.fido2.api.common.AuthenticatorSelectionCriteria[p1];
        return v1_1;
    }
}
