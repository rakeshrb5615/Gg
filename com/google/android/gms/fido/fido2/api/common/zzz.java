...
public final class zzz extends com.google.android.gms.common.internal.safeparcel.AbstractSafeParcelable {
    ...
    static zzz()
    {
        com.google.android.gms.fido.fido2.api.common.zzz.CREATOR = new com.google.android.gms.fido.fido2.api.common.zzaa();
        return;
    }

    public zzz(boolean p1)
    {
    ...
    {
        if ((p3 instanceof com.google.android.gms.fido.fido2.api.common.zzz)) {
            if (this.zza != ((com.google.android.gms.fido.fido2.api.common.zzz) p3).zza) {
                return 0;
            } else {
                return 1;
            }
