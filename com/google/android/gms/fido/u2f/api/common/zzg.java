...
public final class zzg implements android.os.Parcelable$Creator {
    ...
    public final bridge synthetic Object createFromParcel(android.os.Parcel p9)
    {
        ...
        while (p9.dataPosition() < v0) {
            ...
            if (v6 == 1) {
                ...
                if (v6 == 2) {
                    ...
                    if (v6 == 3) {
                        v2_0 = com.google.android.gms.common.internal.safeparcel.SafeParcelReader.createByteArray(p9, v5_0);
                    } else {
                        if (v6 == 4) {
        ...
        return new com.google.android.gms.fido.u2f.api.common.RegisterRequest(v4, v1, v2_0, v3);
    }

    public final synthetic Object[] newArray(int p1)
    {
        com.google.android.gms.fido.u2f.api.common.RegisterRequest[] v1_1 = new com.google.android.gms.fido.u2f.api.common.RegisterRequest[p1];
        return v1_1;
    }
}
