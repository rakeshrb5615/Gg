...
public final class FragmentWrapper extends com.google.android.gms.dynamic.IFragmentWrapper$Stub {
    ...
    private FragmentWrapper(android.app.Fragment p1)
    {
        this.zza = p1;
        return;
    }

    public static com.google.android.gms.dynamic.FragmentWrapper wrap(android.app.Fragment p1)
    {
        if (p1 == 0) {
            return 0;
        } else {
            return new com.google.android.gms.dynamic.FragmentWrapper(p1);
        }
    }
    ...
    {
        return com.google.android.gms.dynamic.FragmentWrapper.wrap(this.zza.getParentFragment());
    }
    ...
    {
        return com.google.android.gms.dynamic.FragmentWrapper.wrap(this.zza.getTargetFragment());
    }
