...
public final class zap implements android.os.Parcelable$Creator {
    ...
    public final bridge synthetic Object createFromParcel(android.os.Parcel p8)
    {
        ...
        while (p8.dataPosition() < v0) {
            ...
            if (v5 == 1) {
                ...
                if (v5 == 2) {
                    ...
                    if (v5 == 3) {
                        v2_1 = com.google.android.gms.common.internal.safeparcel.SafeParcelReader.createTypedList(p8, v4_0, com.google.android.gms.common.server.response.zam.CREATOR);
                    } else {
        ...
        return new com.google.android.gms.common.server.response.zal(v3, v1, v2_1);
    }

    public final synthetic Object[] newArray(int p1)
    {
        com.google.android.gms.common.server.response.zal[] v1_1 = new com.google.android.gms.common.server.response.zal[p1];
        return v1_1;
    }
}
