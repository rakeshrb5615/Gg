...
public final class zaq implements android.os.Parcelable$Creator {
    ...
    public final bridge synthetic Object createFromParcel(android.os.Parcel p8)
    {
        ...
        android.os.Parcel v1 = 0;
        int v3 = 0;
        com.google.android.gms.common.server.response.zan v2_3 = 0;
        while (p8.dataPosition() < v0) {
            ...
            if (v5 == 1) {
                ...
                if (v5 == 2) {
                    v1 = com.google.android.gms.common.internal.safeparcel.SafeParcelReader.createParcel(p8, v4_0);
                } else {
                    if (v5 == 3) {
                        v2_3 = ((com.google.android.gms.common.server.response.zan) com.google.android.gms.common.internal.safeparcel.SafeParcelReader.createParcelable(p8, v4_0, com.google.android.gms.common.server.response.zan.CREATOR));
                    } else {
        ...
        return new com.google.android.gms.common.server.response.SafeParcelResponse(v3, v1, v2_3);
    }

    public final synthetic Object[] newArray(int p1)
    {
        com.google.android.gms.common.server.response.SafeParcelResponse[] v1_1 = new com.google.android.gms.common.server.response.SafeParcelResponse[p1];
        return v1_1;
    }
}
