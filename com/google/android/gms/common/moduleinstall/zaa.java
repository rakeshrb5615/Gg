...
public final class zaa implements android.os.Parcelable$Creator {
    ...
    public final bridge synthetic Object createFromParcel(android.os.Parcel p7)
    {
        ...
        while (p7.dataPosition() < v0) {
            ...
            if (v4 == 1) {
                v1 = com.google.android.gms.common.internal.safeparcel.SafeParcelReader.readBoolean(p7, v3_0);
            } else {
                if (v4 == 2) {
        ...
        return new com.google.android.gms.common.moduleinstall.ModuleAvailabilityResponse(v1, v2);
    }

    public final synthetic Object[] newArray(int p1)
    {
        com.google.android.gms.common.moduleinstall.ModuleAvailabilityResponse[] v1_1 = new com.google.android.gms.common.moduleinstall.ModuleAvailabilityResponse[p1];
        return v1_1;
    }
}
