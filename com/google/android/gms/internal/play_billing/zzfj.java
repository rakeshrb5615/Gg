...
final class zzfj extends com.google.android.gms.internal.play_billing.zzdu implements java.util.RandomAccess, com.google.android.gms.internal.play_billing.zzfm {
    ...
    {
        int[] v1 = new int[0];
        com.google.android.gms.internal.play_billing.zzfj.zza = v1;
        com.google.android.gms.internal.play_billing.zzfj.zzb = new com.google.android.gms.internal.play_billing.zzfj(v1, 0, 0);
        return;
    }

    public zzfj()
    {
        this(com.google.android.gms.internal.play_billing.zzfj.zza, 0, 1);
        return;
    }

    private zzfj(int[] p1, int p2, boolean p3)
    {
        super(p3);
        super.zzc = p1;
        super.zzd = p2;
    ...
    {
        return com.google.android.gms.internal.play_billing.zzfj.zzb;
    }
    ...
    public final synthetic void add(int p5, Object p6)
    {
        ...
        if (p5 >= 0) {
            ...
            if (p5 <= v0_4) {
                ...
                if (v0_4 >= v3_0) {
                    int[] v0_1 = new int[com.google.android.gms.internal.play_billing.zzfj.zzi(v3_0)];
    ...
    public final boolean addAll(java.util.Collection p6)
    {
        ...
        if ((p6 instanceof com.google.android.gms.internal.play_billing.zzfj)) {
            int v0_5 = ((com.google.android.gms.internal.play_billing.zzfj) p6).zzd;
            if (v0_5 != 0) {
                int v2_1 = this.zzd;
                if ((2147483647 - v2_1) < v0_5) {
                    ...
                    System.arraycopy(((com.google.android.gms.internal.play_billing.zzfj) p6).zzc, 0, this.zzc, this.zzd, ((com.google.android.gms.internal.play_billing.zzfj) p6).zzd);
                    this.zzd = v2_0;
                    this.modCount = (this.modCount + 1);
                    return 1;
                }
    ...
    public final boolean equals(Object p6)
    {
        if (this != p6) {
            if ((p6 instanceof com.google.android.gms.internal.play_billing.zzfj)) {
                if (this.zzd == ((com.google.android.gms.internal.play_billing.zzfj) p6).zzd) {
                    int v1_0 = 0;
                    while (v1_0 < this.zzd) {
                        if (this.zzc[v1_0] == ((com.google.android.gms.internal.play_billing.zzfj) p6).zzc[v1_0]) {
                            v1_0++;
                        } else {
                            return 0;
                        }
    ...
    public final bridge synthetic com.google.android.gms.internal.play_billing.zzfn zzd(int p4)
    {
        if (p4 < this.zzd) {
            ...
            if (p4 != null) {
                ...
                v4_3 = com.google.android.gms.internal.play_billing.zzfj.zza;
            }
            return new com.google.android.gms.internal.play_billing.zzfj(v4_3, this.zzd, 1);
        }
    }
    ...
    public final void zzg(int p5)
    {
        this.zza();
        int v1_2 = this.zzc.length;
        if (this.zzd == v1_2) {
            int[] v0_3 = new int[com.google.android.gms.internal.play_billing.zzfj.zzi(v1_2)];
    ...
    public final void zzh(int p2)
    {
        ...
        if (p2 > v0_1) {
            ...
            while (v0_1 < p2) {
                v0_1 = com.google.android.gms.internal.play_billing.zzfj.zzi(v0_1);
            }
