...
public final class zzgf extends java.util.LinkedHashMap {
    ...
    static zzgf()
    {
        com.google.android.gms.internal.play_billing.zzgf v0_1 = new com.google.android.gms.internal.play_billing.zzgf();
        com.google.android.gms.internal.play_billing.zzgf.zza = v0_1;
        v0_1.zzb = 0;
        return;
    }
    ...
    {
        return com.google.android.gms.internal.play_billing.zzgf.zza;
    }

    private static int zzf(Object p2)
    {
        if (!(p2 instanceof byte[])) {
            if ((p2 instanceof com.google.android.gms.internal.play_billing.zzfk)) {
                throw new UnsupportedOperationException();
            } else {
                return p2.hashCode();
            }
        } else {
            UnsupportedOperationException v2_2 = com.google.android.gms.internal.play_billing.zzfo.zzb(((byte[]) p2).length, ((byte[]) p2), 0, ((byte[]) p2).length);
            if (v2_2 == null) {
                v2_2 = 1;
            }
            return v2_2;
    ...
    public final int hashCode()
    {
        ...
        while (v0_1.hasNext()) {
            ...
            v1 += (com.google.android.gms.internal.play_billing.zzgf.zzf(v2_1.getValue()) ^ com.google.android.gms.internal.play_billing.zzgf.zzf(v2_1.getKey()));
        }
        return v1;
    }
    ...
    {
        if (!this.isEmpty()) {
            return new com.google.android.gms.internal.play_billing.zzgf(this);
        } else {
            return new com.google.android.gms.internal.play_billing.zzgf();
        }
    }
    ...
    public final void zzd(com.google.android.gms.internal.play_billing.zzgf p2)
    {
        this.zzg();
        if (!p2.isEmpty()) {
            this.putAll(p2);
