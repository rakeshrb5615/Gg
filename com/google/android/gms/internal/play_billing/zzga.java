...
final class zzga extends com.google.android.gms.internal.play_billing.zzdu implements java.util.RandomAccess, com.google.android.gms.internal.play_billing.zzfn {
    ...
    {
        long[] v1 = new long[0];
        com.google.android.gms.internal.play_billing.zzga.zza = v1;
        new com.google.android.gms.internal.play_billing.zzga(v1, 0, 0);
        return;
    }

    public zzga()
    {
        this(com.google.android.gms.internal.play_billing.zzga.zza, 0, 1);
        return;
    }

    private zzga(long[] p1, int p2, boolean p3)
    {
        super(p3);
        super.zzb = p1;
        super.zzc = p2;
    ...
    public final synthetic void add(int p6, Object p7)
    {
        ...
        if (p6 >= 0) {
            ...
            if (p6 <= v7_7) {
                ...
                if (v7_7 >= v4_0) {
                    long[] v7_4 = new long[com.google.android.gms.internal.play_billing.zzga.zzh(v4_0)];
    ...
    public final boolean addAll(java.util.Collection p6)
    {
        ...
        if ((p6 instanceof com.google.android.gms.internal.play_billing.zzga)) {
            int v0_5 = ((com.google.android.gms.internal.play_billing.zzga) p6).zzc;
            if (v0_5 != 0) {
                int v2_1 = this.zzc;
                if ((2147483647 - v2_1) < v0_5) {
                    ...
                    System.arraycopy(((com.google.android.gms.internal.play_billing.zzga) p6).zzb, 0, this.zzb, this.zzc, ((com.google.android.gms.internal.play_billing.zzga) p6).zzc);
                    this.zzc = v2_0;
                    this.modCount = (this.modCount + 1);
                    return 1;
                }
    ...
    {
        if (this != p9) {
            if ((p9 instanceof com.google.android.gms.internal.play_billing.zzga)) {
                if (this.zzc == ((com.google.android.gms.internal.play_billing.zzga) p9).zzc) {
                    int v1_0 = 0;
                    while (v1_0 < this.zzc) {
                        if (this.zzb[v1_0] == ((com.google.android.gms.internal.play_billing.zzga) p9).zzb[v1_0]) {
                            v1_0++;
                        } else {
                            return 0;
                        }
    ...
    {
        this.zzj(p4);
        return Long.valueOf(this.zzb[p4]);
    }
    ...
    public final bridge synthetic com.google.android.gms.internal.play_billing.zzfn zzd(int p4)
    {
        if (p4 < this.zzc) {
            ...
            if (p4 != null) {
                ...
                v4_3 = com.google.android.gms.internal.play_billing.zzga.zza;
            }
            return new com.google.android.gms.internal.play_billing.zzga(v4_3, this.zzc, 1);
        }
    }
    ...
    public final void zzf(long p5)
    {
        ...
        if (this.zzc == v1_2) {
            long[] v0_3 = new long[com.google.android.gms.internal.play_billing.zzga.zzh(v1_2)];
    ...
    public final void zzg(int p2)
    {
        ...
        if (p2 > v0_1) {
            ...
            while (v0_1 < p2) {
                v0_1 = com.google.android.gms.internal.play_billing.zzga.zzh(v0_1);
            }
