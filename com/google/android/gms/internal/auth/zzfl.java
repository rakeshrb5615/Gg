...
final class zzfl extends com.google.android.gms.internal.auth.zzdq implements java.util.RandomAccess, com.google.android.gms.internal.auth.zzey, com.google.android.gms.internal.auth.zzgd {
    ...
    {
        long[] v2 = new long[0];
        com.google.android.gms.internal.auth.zzfl v0_1 = new com.google.android.gms.internal.auth.zzfl(v2, 0);
        com.google.android.gms.internal.auth.zzfl.zza = v0_1;
        v0_1.zzb();
        return;
    }
    ...
    public zzfl()
    {
        long[] v0_1 = new long[10];
        this(v0_1, 0);
        return;
    }

    private zzfl(long[] p1, int p2)
    {
        this.zzb = p1;
        this.zzc = p2;
        return;
    ...
    public final boolean addAll(java.util.Collection p6)
    {
        ...
        if ((p6 instanceof com.google.android.gms.internal.auth.zzfl)) {
            int v0_5 = ((com.google.android.gms.internal.auth.zzfl) p6).zzc;
            if (v0_5 != 0) {
                int v2_1 = this.zzc;
                if ((2147483647 - v2_1) < v0_5) {
                    ...
                    System.arraycopy(((com.google.android.gms.internal.auth.zzfl) p6).zzb, 0, this.zzb, this.zzc, ((com.google.android.gms.internal.auth.zzfl) p6).zzc);
                    this.zzc = v2_0;
                    this.modCount = (this.modCount + 1);
                    return 1;
                }
    ...
    {
        if (this != p9) {
            if ((p9 instanceof com.google.android.gms.internal.auth.zzfl)) {
                if (this.zzc == ((com.google.android.gms.internal.auth.zzfl) p9).zzc) {
                    int v1_0 = 0;
                    while (v1_0 < this.zzc) {
                        if (this.zzb[v1_0] == ((com.google.android.gms.internal.auth.zzfl) p9).zzb[v1_0]) {
                            v1_0++;
                        } else {
                            return 0;
                        }
    ...
    public final int hashCode()
    {
        ...
        int v1 = 0;
        while (v1 < this.zzc) {
            v0_0 = ((v0_0 * 31) + com.google.android.gms.internal.auth.zzez.zzc(this.zzb[v1]));
            v1++;
        }
        return v0_0;
    }
    ...
    public final bridge synthetic com.google.android.gms.internal.auth.zzey zzd(int p3)
    {
        if (p3 < this.zzc) {
            ...
            return new com.google.android.gms.internal.auth.zzfl(java.util.Arrays.copyOf(this.zzb, p3), this.zzc);
        }
    }
