...
abstract class zzajp extends java.util.AbstractList implements com.google.android.gms.internal.firebase-auth-api.zzalm {
    private boolean zza;

    public zzajp(boolean p1)
    {
        this.zza = p1;
        return;
    }
    ...
    public boolean removeAll(java.util.Collection p1)
    {
        this.zza();
