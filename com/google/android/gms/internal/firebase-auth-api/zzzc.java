...
public final class zzzc implements com.google.android.gms.internal.firebase-auth-api.zzba {
    private final com.google.android.gms.internal.firebase-auth-api.zzht zza;
    private final byte[] zzb;

    private zzzc(byte[] p2, byte[] p3)
    {
        this.zza = new com.google.android.gms.internal.firebase-auth-api.zzht(p2);
        this.zzb = p3;
        return;
    }
    ...
    {
        return new com.google.android.gms.internal.firebase-auth-api.zzzc(p3.zze().zza(com.google.android.gms.internal.firebase-auth-api.zzbf.zza()), p3.zzd().zzb());
    }
    ...
    private final byte[] zzc(byte[] p4, byte[] p5)
    {
        if (p4.length < 28) {
            ...
            return this.zza.zza(java.nio.ByteBuffer.wrap(p4, 12, (p4.length - 12)), java.util.Arrays.copyOf(p4, 12), p5);
        }
    }
    ...
    {
        int v0_3 = java.nio.ByteBuffer.allocate((p4.length + 28));
        byte[] v1_1 = com.google.android.gms.internal.firebase-auth-api.zzqd.zza(12);
        v0_3.put(v1_1);
