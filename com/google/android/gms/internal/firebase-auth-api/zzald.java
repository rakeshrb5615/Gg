...
final class zzald extends com.google.android.gms.internal.firebase-auth-api.zzajp implements com.google.android.gms.internal.firebase-auth-api.zzalm, java.util.RandomAccess {
    ...
    static zzald()
    {
        ...
        com.google.android.gms.internal.firebase-auth-api.zzald.zza = v1;
        new com.google.android.gms.internal.firebase-auth-api.zzald(v1, 0, 0);
        return;
    }

    public zzald()
    {
        this(com.google.android.gms.internal.firebase-auth-api.zzald.zza, 0, 1);
        return;
    }

    private zzald(float[] p1, int p2, boolean p3)
    {
        super(p3);
        super.zzb = p1;
        super.zzc = p2;
    ...
    public final synthetic void add(int p5, Object p6)
    {
        ...
        if (p5 >= 0) {
            ...
            if (p5 <= v0_5) {
                float[] v1_0 = this.zzb;
                if (v0_5 >= v1_0.length) {
                    float[] v0_2 = new float[com.google.android.gms.internal.firebase-auth-api.zzald.zzd(v1_0.length)];
        ...
        throw new IndexOutOfBoundsException(this.zze(p5));
    }

    public final synthetic boolean add(Object p1)
    {
        this.zza(((Float) p1).floatValue());
        return 1;
    }
    ...
    public final boolean addAll(java.util.Collection p6)
    {
        ...
        if ((p6 instanceof com.google.android.gms.internal.firebase-auth-api.zzald)) {
            int v0_5 = ((com.google.android.gms.internal.firebase-auth-api.zzald) p6).zzc;
            if (v0_5 != 0) {
                int v2_1 = this.zzc;
                if ((2147483647 - v2_1) < v0_5) {
                    ...
                    System.arraycopy(((com.google.android.gms.internal.firebase-auth-api.zzald) p6).zzb, 0, this.zzb, this.zzc, ((com.google.android.gms.internal.firebase-auth-api.zzald) p6).zzc);
                    this.zzc = v2_0;
                    this.modCount = (this.modCount + 1);
                    return 1;
                }
    ...
    public final boolean equals(Object p6)
    {
        if (this != p6) {
            if ((p6 instanceof com.google.android.gms.internal.firebase-auth-api.zzald)) {
                if (this.zzc == ((com.google.android.gms.internal.firebase-auth-api.zzald) p6).zzc) {
                    int v1_0 = 0;
                    while (v1_0 < this.zzc) {
                        if (Float.floatToIntBits(this.zzb[v1_0]) == Float.floatToIntBits(((com.google.android.gms.internal.firebase-auth-api.zzald) p6).zzb[v1_0])) {
                            v1_0++;
                        } else {
                            return 0;
                        }
    ...
    {
        return Float.valueOf(this.zzb(p1));
    }
    ...
    public final synthetic com.google.android.gms.internal.firebase-auth-api.zzalm zza(int p4)
    {
        if (p4 < this.zzc) {
            ...
            if (p4 != null) {
                ...
                v4_3 = com.google.android.gms.internal.firebase-auth-api.zzald.zza;
            }
            return new com.google.android.gms.internal.firebase-auth-api.zzald(v4_3, this.zzc, 1);
        }
    }

    public final void zza(float p5)
    {
        this.zza();
        int v1_1 = this.zzb;
        if (this.zzc == v1_1.length) {
            float[] v0_4 = new float[com.google.android.gms.internal.firebase-auth-api.zzald.zzd(v1_1.length)];
    ...
    public final void zzc(int p3)
    {
        ...
        if (p3 > v0_0.length) {
            if (v0_0.length != 0) {
                ...
                while (v0_1 < p3) {
                    v0_1 = com.google.android.gms.internal.firebase-auth-api.zzald.zzd(v0_1);
                }
                this.zzb = java.util.Arrays.copyOf(this.zzb, v0_1);
                return;
            } else {
                float[] v3_2 = new float[Math.max(p3, 10)];
                this.zzb = v3_2;
                return;
            }
        } else {
