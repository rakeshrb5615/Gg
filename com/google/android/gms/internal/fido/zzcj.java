...
public final class zzcj {
    ...
    public static int zza(int p5, int p6, java.math.RoundingMode p7)
    {
        ...
        if (p6 == 0) {
            ...
            if (v1_3 != 0) {
                ...
                switch (com.google.android.gms.internal.fido.zzci.zza[p7.ordinal()]) {
                    case 1:
                        com.google.android.gms.internal.fido.zzck.zza(0);
                        return v0;
                    case 2:
                        break;
                    case 3:
    ...
    public static int zzb(int p1, java.math.RoundingMode p2)
    {
        if (p1 <= 0) {
            ...
            switch (com.google.android.gms.internal.fido.zzci.zza[p2.ordinal()]) {
                case 1:
                    int v2_7;
                    if (((p1 - 1) & p1) != 0) {
                        v2_7 = 0;
                    ...
                    com.google.android.gms.internal.fido.zzck.zza(v2_7);
                case 2:
                case 3:
                    break;
                case 2:
