...
public final class zzc {
    ...
    static zzc()
    {
        com.google.android.gms.internal.common.zzc.zzb = com.google.android.gms.internal.common.zzc.getClassLoader();
        return;
    }
    ...
    public static void zzd(android.os.Parcel p1, android.os.Parcelable p2)
    {
        if (p2 != 0) {
            p1.writeInt(1);
            p2.writeToParcel(p1, 1);
            return;
        } else {
            p1.writeInt(0);
            return;
