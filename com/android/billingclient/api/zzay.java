...
final class zzay extends android.os.ResultReceiver {
    ...
    public zzay(com.android.billingclient.api.BillingClientImpl p1, android.os.Handler p2, com.android.billingclient.api.AlternativeBillingOnlyInformationDialogListener p3)
    {
        this.zza = p3;
    ...
    public final void onReceiveResult(int p6, android.os.Bundle p7)
    {
        ...
        if (p6 != null) {
            if (p7 != null) {
                ...
                com.android.billingclient.api.BillingClientImpl.zzZ(v1_0, com.android.billingclient.api.zzcg.zzb(v6_2, 16, v0_0.build(), p7.getString("INTERNAL_LOG_ERROR_ADDITIONAL_DETAILS"), com.google.android.gms.internal.play_billing.zzil.zza));
            } else {
                com.android.billingclient.api.BillingClientImpl.zzY(this.zzb, this.zza, com.android.billingclient.api.zzcj.zzh, com.google.android.gms.internal.play_billing.zzie.zzau, 0);
                return;
            }
        }
        this.zza.onAlternativeBillingOnlyInformationDialogResponse(v0_0.build());
        return;
    }
}
